  ...
  return (
    <section className='imgSection'>
        ...
        <div className='comfort-container' >
          <p className='img-text' style={{padding:"20px", textAlign:"center"}} data-languagePartIdentifier= "smart_climate_desc_long">Optimize your home's climate with our Temperature Control Module and Heating Actuators. 
        ...
        <div className='smart-climate'>
          <div className='validation' style={{background: "black"}}>
            <h2 style={{textAlign:"center", fontSize:"52px", fontStyle:"normal", fontFamily:"Roboto", fontWeight:"400", letterSpacing:"0.2px", padding:"20px"}} data-languagePartIdentifier= "advanced_home_security">Advanced Home Securitys</h2>
        ...
        <div className='keeping-home'>
          <h2 style={{textAlign:"left", fontSize:"31px", fontStyle:"normal", fontFamily:"Roboto", fontWeight:"400", letterSpacing:"0.2px", color:"black", padding:"30px"}} data-languagePartIdentifier= "keeping_your_home_safe">Keeping Your Home Safe:</h2>
          <h2 style={{textAlign:"left", fontSize:"52px", fontStyle:"normal", fontFamily:"Roboto", fontWeight:"400", letterSpacing:"0.2px", color:"black"}} data-languagePartIdentifier= "smart_security_solutions">Smart Security Solutions </h2>
          <p className='imgText' style={{padding:"30px", textAlign: "center"}} data-languagePartIdentifier= "smart_security_solutions_desc">
        ...
        <div className='smart-climate'>
          <div className='validation' style={{background: "black"}}>
            <h2 style={{textAlign:"center", fontSize:"52px", fontStyle:"normal", fontFamily:"Roboto", fontWeight:"400", letterSpacing:"0.2px", padding:"20px"}} data-languagePartIdentifier= "realtime_home_management">Real-Time Home Management</h2>
        ...
        <p className='img-text' style={{ padding: '20px' }} data-languagePartIdentifier=  "realtime_home_management_desc_long">
        ...
        <div className='smart-climate'>
          <div className='validation' style={{background: "black"}}>
            <h2 style={{textAlign:"center", fontSize:"52px", fontStyle:"normal", fontFamily:"Roboto", fontWeight:"400", letterSpacing:"0.2px"}} data-languagePartIdentifier= "beehive_energy_saving">BeeHive AI Energy Saving</h2>
