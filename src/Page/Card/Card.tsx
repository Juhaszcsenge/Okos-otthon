  ...
  return (
    ...
    <div className='home-table' style={{background: "black", boxShadow: "0px 4px 31px 0px rgba(0, 0, 0, 0.15)", position:"relative"}}>
        ...
        <div style={{width: "32px", height: "32px"}}>
          <img src='one-finger-tap.png' alt='' style={{height:"32px", width:"32px"}}></img>
        </div>
        ...
        <img src='hierarchy-13--node-organization-links-structure-link-nodes-network-hierarchy.png' alt=''  style={{height:"32px", width:"32px"}}></img>
        </div>
        ...
        <div className='card' style={{background: "black"}}>
        <div style={{width: "29px", height: "29px"}}>
        <img src='Check_ring_light.png' alt=''  style={{height:"32px", width:"32px"}}></img>
        </div>
