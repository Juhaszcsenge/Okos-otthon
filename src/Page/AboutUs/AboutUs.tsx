...
const AboutUs = () => {
  ...
  return (
    ...
    <div className='aboutLeft' style={{marginBottom: "200px"}}>
    ...
    <div className='about-containerLeft'>
          ...
          <p style={{marginTop: "30px"}} className='about-text'  data-languagePartIdentifier="our_commited">Our commitment extends beyond technology; it's about understanding your unique needs and aspirations. We're your partner in creating a smarter, more comfortable, and safer living space. 
